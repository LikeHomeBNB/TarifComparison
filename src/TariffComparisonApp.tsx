    ...
    <div className="min-h-screen bg-gray-50" style={{
      ...
      <style>{`
        @media print {
          ...
          .print-header { display: block !important; margin-bottom: 20px; padding: 20px; background: #1B2C22 !important; color: white !important; }
      ...
      <div className="max-w-7xl mx-auto p-6">
        {/* Project Info */}
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8 border-l-4" style={{ borderColor: 'var(--sage-green)' }}>
            ...
            <table className="w-full">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100">
                  <td className="p-4 font-semibold flex items-center bg-gray-50" style={{ color: 'var(--charcoal)' }}>
                  ...
                  <td className="p-4 text-center font-semibold bg-yellow-100 text-yellow-800">
                  ...
                  {providers.map((provider, index) => (
                    <td key={index} className="p-2">
                      <div className="grid grid-cols-2 gap-1">
                        ...
                        <div className="p-2 text-center font-semibold bg-gray-100" style={{ color: 'var(--charcoal)' }}>
                ...
                {projectInfo.serviceType !== 'internet' && (
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="p-4 text-center font-semibold bg-yellow-100 text-yellow-800">20%</td>
                    {providers.map((provider, index) => (
                      <td key={index} className="p-2">
                        <div className="grid grid-cols-2 gap-1">
                          <div className="bg-gray-50">
                ...
                {projectInfo.serviceType === 'internet' && (
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="p-4 text-center font-semibold bg-yellow-100 text-yellow-800">35%</td>
                    {providers.map((provider, index) => (
                      <td key={index} className="p-2">
                        <div className="grid grid-cols-2 gap-1">
                          <div className="bg-gray-50">
                ...
                {projectInfo.serviceType !== 'internet' && (
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="p-4 text-center font-semibold bg-yellow-100 text-yellow-800">15%</td>
                    {providers.map((provider, index) => (
                      <td key={index} className="p-2">
                        <div className="grid grid-cols-2 gap-1">
                          <div className="bg-gray-50">
        ...
        {/* Methodology */}
        <div className="bg-white rounded-xl shadow-lg p-6 no-print border-l-4" style={{ borderColor: 'var(--sage-green)' }}>
